    ...
    <div class="card my-5 col-xl-9 col-xxl-8 mx-auto rounded-4 overflow-hidden p-4">
        <div class="row g-4">
            <div class="col-lg-6 d-flex">
                <div class="card-body">
                    <h4 class="fw-bold">Register Now And Start Posting</h4>
                    <p class="mb-0">Enter you information to create an account</p>
                        ...
                        <form class="row g-3" method="post" action="register" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group" id="show_hide_password2">
                                    <input type="password" class="form-control border-end-0" name="passwordConfirm"
                                           id="password2"
                                           placeholder="Enter Password">
                                    <a href="javascript:;" class="input-group-text bg-transparent"><i
                                            class="bi bi-eye-slash-fill"></i></a>
                            ...
                            <div class="col-12">
                                ...
                                <input type="file" class="form-control border-end-0" name="picture" id="picture">
                            </div>
                            <div class="col-md-6">
            ...
            <div class="col-lg-6 d-lg-flex d-none">
                <div class="p-3 rounded-4 w-100 d-flex align-items-center justify-content-center bg-light">
                    <img src="${pageContext.request.contextPath}/resources/assets/images/register_now.png"
                         class="img-fluid" alt="">
                </div>
            </div>
